...
sudo cp mifosplatform-1.25.1.RELEASE/mifosng-provider.war $TOMCAT_HOME/webapps
sudo mkdir $TOMCAT_HOME/webapps/ROOT
sudo mkdir $TOMCAT_HOME/webapps/ROOT/apps
sudo cp -r api-docs $TOMCAT_HOME/webapps/ROOT
sudo cp -r apps/community-app $TOMCAT_HOME/webapps/ROOT/apps
