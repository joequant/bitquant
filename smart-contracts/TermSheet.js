...
This FACILITY AGREEMENT is dated ****  between

1) YOYODYNE Ltd incorporated and registered in Hong Kong with company
number 1234552 whose registered office is at 1600 Pennsylvia Avenue
(BORROWER)
...
In this Agreement:
1.2.1 unless the context otherwise requires, words in the singular shall include the plural and in the plural shall include the singular;
1.2.2 unless the context otherwise requires, a reference to one gender shall include a reference to the other genders;
1.2.3 a reference to a party shall include that party's successors, permitted assigns and permitted transferees;
...
1.2.5 a reference to writing  or written includes mail, fax and e-mail; 
1.2.6 unless the context otherwise requires, a reference to a clause or Schedule is to a clause of, or Schedule to, this Agreement; and
...
3.1 The Borrower shall use all money borrowed under this Agreement for the sole purpose of expanding its business.
...
5.1 The Borrower shall pay interest on the Loan as specified in the Schedule of this Agreement

5.3 If the Borrower fails to make any payment due under this Agreement on the due date for payment, interest on the unpaid amount shall accrue daily, from the date of non-payment to the date of actual payment (both before and after judgment), at 5% above the rate specified in clause 5.1.

6 Costs
6.1 The Lender shall bear all costs and expenses (together with any value added tax on them) that the Lender incurs in connection with the negotiation and preservation and enforcement of the Loan and/or this Agreement.
...
7 Repayment
7.1 The Borrower shall repay the Loan as specified in the attached schedule.

7.2 All payments made by the Borrower under this Agreement shall be made in full, without set-off, counterclaim or condition, and free and clear of, and without any deduction or withholding.

8 Representations, Warranties and Undertakings

8.1The Borrower represents, warrants and undertakes to the Lender on the date of this Agreement:
It:
...
8.2 The entry into and performance by it of, and the transactions contemplated by, this Agreement, do not and will not contravene or conflict with:
...
9.1 Each of the events or circumstances set out in this clause 9 is an Event of Default.
...
10.4 The rights and remedies provided under this Agreement are cumulative and are in addition to, and not exclusive of, any rights and remedies provided by law.
...
14 Notices
14.1 Any notice or other communication given to a party under or in connection with this Agreement shall be:
(a) in writing;
...
Attention:  Random Foo

the Lender at:
Address:221B Baker Street
Email: drwatson@example.com
Attention:  Dr. John Watson
or to any other address or fax number as is notified in writing by one party to the other from time to time.

14.2 Any notice or other communication that the Lender gives to the Borrower under or in connection with, this Agreement shall be deemed to have been received:
...
14.3 A notice or other communication given on a day that is not a Business Day, or after normal business hours, in the place it is received, shall be deemed to have been received on the next Business Day.

14.4 Any notice or other communication given to the Lender shall be deemed to have been received only on actual receipt.
