...
-----------------
  ...
  * Total Loss: the Equipment is, in the Lessor's reasonable opinion [or the opinion of its insurer(s)], damaged beyond repair, lost, stolen, seized or confiscated.
   ...
   3.9 A reference to a statute or statutory provision shall include all subordinate legislation made [from time to time OR as at the date of this agreement] under that statute or statutory provision.
   3.10 A reference to writing or written includes fax and e-mail
   3.11 Any obligation on a party not to do something includes an obligation not to allow that thing to be done.
   3.12 [A reference to this agreement or to any other agreement or document referred to in this agreement is a reference to this agreement or such other agreement or document as varied or novated (in each case, other than in breach of the provisions of this agreement) from time to time.]
   3.13 References to clauses and schedules are to the clauses and schedules of this agreement and references to paragraphs are to paragraphs of the relevant schedule. 
   3.14 Any words following the terms including, include, in particular, for example or any similar expression shall be construed as illustrative and shall not limit the sense of the words, description, definition, phrase or term preceding those terms.
...
------------------------------
6.1 The Lessee shall pay the Rental Payments to the Lessor in accordance with the Payment Schedule. The Rental Payments shall be paid in [CURRENCY] and shall be made by [PAYMENT METHOD].
...
9. Purchase Option
------------------
9.1 The Lessee shall, subject to clause 8.2, have the option, exercisable by not less than [twenty (20)] Business Days' written notice to the Lessor, to purchase the Equipment on the last Business Day of the Rental Period at the Purchase Option Price. 
...
9.3 Upon completion of the purchase of the Equipment under this clause 8, such title to the Equipment as the Lessor had on the Commencement Date shall transfer to the Lessee. 
...
----------------------
11.1 The leasee may pay an end to this agreement by returning the goods to the owner and giving him written notice of termination of this agreement.
11.2 He must them pay any installments which are in arrear at the time he gives notice.  If when he has paid the installments, the total amount which he has paid under the agreement is less than ***, he must also pay enough to make up that sum
11.3. If the goods have been damaged owing to the hirer having failed to take reasomable care of them, the lessor may sue him for the amount of the damage uneless that amount can be agreed between the lessor and lessee.
11.4. The lessor must return the goods at his own expense to the premises from which they were originally supplied to him or to such other place as the owner may direct.  The owner must reimburse the hirer for any additional expense incurred in returning the goods to premises other than those from which they were originally supplied.
11.5. The hirer should see whether this agreement contains provisions allowing him to put an end to the agreement on terms more favourable to him than those just mentioned.  If it does he may put an end to the agreement on those terms.

Right of hirer to complete agreement
------------------------------------
12.1. The hirer may after previous notice in writing to the owner complete the purchase of the goods comprised in this agreement by paying the owner on a day specificed in the notice the "net balance" due to the owners
12.2 The "net balance" means the balance originally payable under the agreement less any amounts (other than the deposit) paid or provided, whether by cash or other consideration, by or on behalf of the hirer under the agreement.
12.3 The hirer may complete the purchase under paragraph 1 above ither
