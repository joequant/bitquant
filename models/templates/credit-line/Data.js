...
explanations[2] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[3] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[4] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[5] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[6] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[7] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[8] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[9] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[10] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[11] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[12] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[13] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[14] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[15] = 'Only for testing now This clause specifies the important definitions used in this contract';
explanations[16] = 'Only for testing now This clause specifies the important definitions used in this contract';
...
clauses[16] = '<ul><li>Any principal due under this Agreement may be paid via HKD or via bitcoins based on the XBT Exchange Rate. Any interest (including default interest) due under this Agreement must be paid via bitcoins based on the XBT Exchange Rate. </li>'+
	'<li>Any previous unused credit lines between the borrower and lender are hereby cancelled. This will not affect the payment and conditions of any credit lines which have already been used, or the payment and conditions of any loans that have been obtained outside of a credit line. </li>'+
	'<li>The borrower warrants that they have received a grant from the HKSAR over the duration of this credit line exceeding the total amount available. In the event that the borrower is no longer eligible for the grant, this credit line shall be cancelled, with the balance due with finance charge within 30 days. </li>'+
	'<li>In the event that the HKSAR fails to provide a grant payment before the deadline for the payments owed in this credit line, the deadline shall be extended until three days after borrower has received payment from the HKSAR or forty-five (90) days after the end of quarter.</li></ul>';
